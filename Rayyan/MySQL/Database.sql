...
-- Dumping data for table store.address_store: ~1 rows (approximately)
INSERT INTO `address_store` (`id`, `customer_id`, `address`, `district`, `city`, `province`, `postal_code`, `created_at`, `updated_at`) VALUES
...
-- Dumping data for table store.customer_store: ~4 rows (approximately)
INSERT INTO `customer_store` (`id`, `title`, `name`, `gender`, `phone_number`, `image`, `email`, `created_at`, `updated_at`) VALUES
